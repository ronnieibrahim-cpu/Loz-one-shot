...
2. **PT — terrain polish. Steps 1-4 (towns and buildings) are DONE**; read the
   PT section at the top of this file before touching a town screen, and run
   `node tools/check-towns.mjs`. What is left of PT is step 5, the terrain
   backlog, whose big item is the `cliff` family. The historical note, kept
   because it is where the kit came from —
