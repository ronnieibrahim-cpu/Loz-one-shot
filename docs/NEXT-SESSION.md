...
## THE BOARD, UPDATED AGAIN — title screen art landed, and P9's health economy: the cap was 13 and nothing could see it

Two branches merged into this board at once: the title screen is drawn art
now (`claude/title-screen-art-j2lyg9`), and P9's health-economy audit found
and fixed a wrong maximum-health cap (`claude/p9-heart-health-economy-crpqyb`).
Full detail for each follows as its own section below; neither touched the
other's files.
