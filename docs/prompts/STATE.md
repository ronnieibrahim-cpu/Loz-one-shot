...
S5 | objective | built tools/shoot-sprites.mjs (labelled, real-pixel contact sheets per sprite pack, 1x+3x, 327 manifest entries, 0 missing); no sprite file touched, tagging is next session's job
